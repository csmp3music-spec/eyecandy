...
enum PresetLibrary {
    static let synthVoicePresets: [SynthVoicePreset] = [
        ...
        SynthVoicePreset(name: "Buchla Folded Orbit", voice: SynthVoice(instrument: .buchlaComplex, enabled: true, level: 0.40, octave: 3, cutoff: 0.68, resonance: 0.34, glide: 0.07, accent: 0.54, attack: 0.01, decay: 0.46, sustain: 0.20, drive: 0.38, filterEnvelope: 0.42, lfoRate: 0.33, lfoAmount: 0.44, morph: 0.72, unison: 0.18, detune: 0.14, subLevel: 0.06, noiseLevel: 0.08, fmAmount: 0.74, wavefold: 0.82, grainSize: 0.18, grainDensity: 0.32, bitcrush: 0.04)),
        SynthVoicePreset(name: "Mellotron Nebula Choir", voice: SynthVoice(instrument: .mellotronTape, enabled: true, level: 0.36, octave: 3, cutoff: 0.58, resonance: 0.26, glide: 0.04, accent: 0.18, attack: 0.20, decay: 0.88, sustain: 0.70, drive: 0.18, filterEnvelope: 0.20, lfoRate: 0.22, lfoAmount: 0.32, morph: 0.64, unison: 0.26, detune: 0.40, subLevel: 0.04, noiseLevel: 0.18, fmAmount: 0.18, wavefold: 0.06, grainSize: 0.42, grainDensity: 0.36, bitcrush: 0.02)),
        SynthVoicePreset(name: "Solina Star Stringer", voice: SynthVoice(instrument: .solinaStringer, enabled: true, level: 0.38, octave: 4, cutoff: 0.66, resonance: 0.20, glide: 0.03, accent: 0.20, attack: 0.16, decay: 0.78, sustain: 0.64, drive: 0.16, filterEnvelope: 0.18, lfoRate: 0.28, lfoAmount: 0.42, morph: 0.58, unison: 0.72, detune: 0.44, subLevel: 0.04, noiseLevel: 0.04, fmAmount: 0.12, wavefold: 0.04, grainSize: 0.18, grainDensity: 0.28, bitcrush: 0.01)),
        SynthVoicePreset(name: "Synclavier Crystal FM", voice: SynthVoice(instrument: .synclavierDigital, enabled: true, level: 0.40, octave: 4, cutoff: 0.76, resonance: 0.48, glide: 0.02, accent: 0.44, attack: 0.02, decay: 0.52, sustain: 0.22, drive: 0.20, filterEnvelope: 0.44, lfoRate: 0.38, lfoAmount: 0.24, morph: 0.76, unison: 0.18, detune: 0.10, subLevel: 0.02, noiseLevel: 0.02, fmAmount: 0.86, wavefold: 0.20, grainSize: 0.12, grainDensity: 0.22, bitcrush: 0.06)),
        SynthVoicePreset(name: "Vector Morph Dimension", voice: SynthVoice(instrument: .vectorMorph, enabled: true, level: 0.42, octave: 4, cutoff: 0.72, resonance: 0.32, glide: 0.06, accent: 0.40, attack: 0.04, decay: 0.62, sustain: 0.34, drive: 0.28, filterEnvelope: 0.36, lfoRate: 0.46, lfoAmount: 0.54, morph: 0.82, unison: 0.52, detune: 0.32, subLevel: 0.04, noiseLevel: 0.03, fmAmount: 0.54, wavefold: 0.22, grainSize: 0.22, grainDensity: 0.38, bitcrush: 0.04)),
        SynthVoicePreset(name: "Vocal Circuit Carrier", voice: SynthVoice(instrument: .vocoderCarrier, enabled: true, level: 0.40, octave: 4, cutoff: 0.76, resonance: 0.48, glide: 0.06, accent: 0.46, attack: 0.03, decay: 0.52, sustain: 0.28, drive: 0.34, filterEnvelope: 0.42, lfoRate: 0.28, lfoAmount: 0.26, morph: 0.64, unison: 0.42, detune: 0.26, subLevel: 0.04, noiseLevel: 0.02, fmAmount: 0.28, wavefold: 0.14, grainSize: 0.18, grainDensity: 0.32, bitcrush: 0.02, chorus: 0.42, shimmer: 0.28, sidechain: 0.34)),
        SynthVoicePreset(name: "Harmonic Choir Glass", voice: SynthVoice(instrument: .choirHarmonics, enabled: true, level: 0.38, octave: 4, cutoff: 0.70, resonance: 0.54, glide: 0.10, accent: 0.22, attack: 0.16, decay: 0.82, sustain: 0.62, drive: 0.18, filterEnvelope: 0.28, lfoRate: 0.22, lfoAmount: 0.38, morph: 0.66, unison: 0.56, detune: 0.34, subLevel: 0.03, noiseLevel: 0.04, fmAmount: 0.24, wavefold: 0.08, grainSize: 0.36, grainDensity: 0.46, bitcrush: 0.01, chorus: 0.52, shimmer: 0.38, sidechain: 0.22)),
        SynthVoicePreset(name: "Resonator Bloom Keys", voice: SynthVoice(instrument: .resonatorBloom, enabled: true, level: 0.40, octave: 4, cutoff: 0.78, resonance: 0.62, glide: 0.03, accent: 0.48, attack: 0.01, decay: 0.48, sustain: 0.22, drive: 0.26, filterEnvelope: 0.56, lfoRate: 0.32, lfoAmount: 0.24, morph: 0.48, unison: 0.22, detune: 0.16, subLevel: 0.02, noiseLevel: 0.06, fmAmount: 0.42, wavefold: 0.32, grainSize: 0.26, grainDensity: 0.38, bitcrush: 0.03, chorus: 0.26, shimmer: 0.34, sidechain: 0.28))
    ]
    ...
    static func minterProfile(for preset: VisualPreset) -> MinterPresetProfile? {
        ...
        let holoModes: [HolographicMode] = [.off, .ghostPrism, .chromaDepth, .interference, .pepperGhost, .lightField, .cghSpeckle, .realisticStack]
    ...
    static func proceduralProfile(for preset: VisualPreset, seed: Int) -> MinterPresetProfile {
        ...
        let holoModes: [HolographicMode] = preset.family == .holographic
            ? [.ghostPrism, .scanVolume, .chromaDepth, .interference, .pepperGhost, .lightField, .cghSpeckle, .realisticStack]
            : [.off, .ghostPrism, .scanVolume, .chromaDepth, .interference, .pepperGhost, .lightField, .cghSpeckle]
    ...
    private static func psychedelicDrumPresets() -> [DrumPreset] {
        let names = [
            ...
            "Vocoder Stepper", "Chrome Half-Time", "Prismatic Soca", "Night Drive Breaks",
            "Orbit Dembow", "Folding Footwork", "Aurora Electro", "Laser Polymeter"
        ]
